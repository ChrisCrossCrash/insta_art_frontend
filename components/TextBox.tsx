...
const TextBox = ({
  ...
  useEffect(() => {
    ...
    if (!textBox) throw new Error('TextBox: textBoxRef is null')

    const textBoxBtn =
      textBox.querySelector<HTMLButtonElement>('.textbox__btn')!
    const textBoxFooter =
      textBox.querySelector<HTMLDivElement>('.textbox__footer')!
    const textBoxFade = textBox.querySelector<HTMLDivElement>('.textbox__fade')!
    ...
    >
      ...
      <div className='textbox__footer'>
        ...
        >
          ...
          >
            <button
              className={`${btnClassName ? btnClassName : ''} textbox__btn`}
            >
              Read More
            </button>
          </div>
