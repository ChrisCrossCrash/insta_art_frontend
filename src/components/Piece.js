        ...
        <Card style={{boxShadow: '5px 5px 10px #00000022'}}>
          <Card.Body>
            <Card.Title style={{
              ...
              {piece.title}
              <Button variant='outline-dark' size='sm' href={piece.wikiUrl} target='_blank'>
            ...
            <div style={{marginBottom: '1em'}}>
              <div>
                ...
                <Badge as="a" pill variant="secondary" href="https://www.cnn.com">{piece.artist}</Badge>
              </div>
              <div>
                <span className="small text-muted font-weight-bold">Location: </span>
                <Badge as="a" pill variant="secondary" href="#">{piece.location}</Badge>
              </div>
              <div>
                <span className="small text-muted font-weight-bold">Art movements: </span>
                {piece.movements.map(movement =>
                  <React.Fragment>
                    <Badge as="a" pill variant="secondary" href="#">{movement}</Badge>{' '}
                  </React.Fragment>
                )}
              </div>
            </div>
            <Card.Text>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab consectetur cum, doloribus ea enim eos laborum maxime nihil nobis numquam odit perferendis praesentium quasi quisquam quod repudiandae unde velit voluptate.
            </Card.Text>
          </Card.Body>
        </Card>
      </Col>
